...
class ReplyTopicTestCase(TestCase):
	...
	def setUp(self):
		...
		Post.objects.create(message='Lorem ipsum dolor si amet', topic=self.topic, created_by=user)
...
class SuccessfulReplyTopicTests(ReplyTopicTestCase):
	...
	def test_redirection(self):
		url = reverse('topic_posts', kwargs={'pk': self.board.pk, 'topic.pk': self.topic.pk})
